 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class QuoteDataTotalsInterface implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'couponCode' => 'string',
        'itemsQty' => 'int',
        'items' => '\Krak\MagentoApiClient\Model\QuoteDataTotalsItemInterface[]',
        'totalSegments' => '\Krak\MagentoApiClient\Model\QuoteDataTotalSegmentInterface[]',
        'extensionAttributes' => '\Krak\MagentoApiClient\Model\QuoteDataTotalsExtensionInterface'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['weeeTaxAppliedAmount'] === null) {
            $invalidProperties[] = "'weeeTaxAppliedAmount' can't be null";
        }
        if ($this->container['totalSegments'] === null) {
            $invalidProperties[] = "'totalSegments' can't be null";
        }
     ...
     * Gets items
     *
     * @return \Krak\MagentoApiClient\Model\QuoteDataTotalsItemInterface[]
     */
     ...
     * Sets items
     *
     * @param \Krak\MagentoApiClient\Model\QuoteDataTotalsItemInterface[] $items Totals by items
     *
     * @return $this
     */
     ...
     * Gets totalSegments
     *
     * @return \Krak\MagentoApiClient\Model\QuoteDataTotalSegmentInterface[]
     */
     ...
     * Sets totalSegments
     *
     * @param \Krak\MagentoApiClient\Model\QuoteDataTotalSegmentInterface[] $totalSegments Dynamically calculated totals
     *
     * @return $this
     */
     ...
     *
     * @return \Krak\MagentoApiClient\Model\QuoteDataTotalsExtensionInterface
     */
     ...
     *
     * @param \Krak\MagentoApiClient\Model\QuoteDataTotalsExtensionInterface $extensionAttributes extensionAttributes
     *
     * @return $this
     */
