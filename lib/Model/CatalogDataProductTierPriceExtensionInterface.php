 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CatalogDataProductTierPriceExtensionInterface implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['percentageValue'] = isset($data['percentageValue']) ? $data['percentageValue'] : null;
    ...
    /**
     * Gets percentageValue
     *
     * @return float
     */
    public function getPercentageValue()
    {
        return $this->container['percentageValue'];
    }

    /**
     * Sets percentageValue
     *
     * @param float $percentageValue percentageValue
     *
     * @return $this
     */
    public function setPercentageValue($percentageValue)
    {
        $this->container['percentageValue'] = $percentageValue;
