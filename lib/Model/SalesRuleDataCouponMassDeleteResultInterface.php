...
class SalesRuleDataCouponMassDeleteResultInterface implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['failedItems'] = isset($data['failedItems']) ? $data['failedItems'] : null;
        $this->container['missingItems'] = isset($data['missingItems']) ? $data['missingItems'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['failedItems'] === null) {
            $invalidProperties[] = "'failedItems' can't be null";
        }
        if ($this->container['missingItems'] === null) {
            $invalidProperties[] = "'missingItems' can't be null";
        }
    ...
    {
        return $this->container['failedItems'];
    }

    /**
     * Sets failedItems
     *
     * @param string[] $failedItems List of failed items.
     *
     * @return $this
     */
    public function setFailedItems($failedItems)
    {
        $this->container['failedItems'] = $failedItems;
    ...
    {
        return $this->container['missingItems'];
    }

    /**
     * Sets missingItems
     *
     * @param string[] $missingItems List of missing items.
     *
     * @return $this
     */
    public function setMissingItems($missingItems)
    {
        $this->container['missingItems'] = $missingItems;
