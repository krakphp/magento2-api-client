 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CatalogInventoryStockStatusCriteriaInterface implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'criteriaList' => '\Krak\MagentoApiClient\Model\FrameworkCriteriaInterface[]',
        'filters' => 'string[]',
        'orders' => 'string[]',
        'limit' => 'string[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mapperInterfaceName'] === null) {
            $invalidProperties[] = "'mapperInterfaceName' can't be null";
        }
        if ($this->container['criteriaList'] === null) {
            $invalidProperties[] = "'criteriaList' can't be null";
        }
     ...
     * Gets criteriaList
     *
     * @return \Krak\MagentoApiClient\Model\FrameworkCriteriaInterface[]
     */
     ...
     * Sets criteriaList
     *
     * @param \Krak\MagentoApiClient\Model\FrameworkCriteriaInterface[] $criteriaList Criteria objects added to current Composite Criteria
     *
     * @return $this
     */
