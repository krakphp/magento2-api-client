...
class SalesDataTransactionInterface implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'createdAt' => 'string',
        'childTransactions' => '\Krak\MagentoApiClient\Model\SalesDataTransactionInterface[]',
        'extensionAttributes' => '\Krak\MagentoApiClient\Model\SalesDataTransactionExtensionInterface'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['txnId'] === null) {
            $invalidProperties[] = "'txnId' can't be null";
        }
        if ($this->container['parentTxnId'] === null) {
            $invalidProperties[] = "'parentTxnId' can't be null";
        }
        if ($this->container['txnType'] === null) {
            $invalidProperties[] = "'txnType' can't be null";
        }
        ...
        if ($this->container['childTransactions'] === null) {
            $invalidProperties[] = "'childTransactions' can't be null";
        }
     ...
     *
     * @param \Krak\MagentoApiClient\Model\SalesDataTransactionInterface[] $childTransactions Array of child transactions.
     *
     * @return $this
     */
     ...
     *
     * @return \Krak\MagentoApiClient\Model\SalesDataTransactionExtensionInterface
     */
     ...
     *
     * @param \Krak\MagentoApiClient\Model\SalesDataTransactionExtensionInterface $extensionAttributes extensionAttributes
     *
     * @return $this
     */
