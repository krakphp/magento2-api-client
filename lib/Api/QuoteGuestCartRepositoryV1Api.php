...
class QuoteGuestCartRepositoryV1Api
{
    ...
    public function quoteGuestCartRepositoryV1GetGetWithHttpInfo($cartId)
    {
        ...
        $request = $this->quoteGuestCartRepositoryV1GetGetRequest($cartId);
    ...
    /**
     * Operation quoteGuestCartRepositoryV1GetGetAsync
     *
     * 
     *
     * @param  string $cartId (required)
     ...
     */
    public function quoteGuestCartRepositoryV1GetGetAsync($cartId)
    {
        return $this->quoteGuestCartRepositoryV1GetGetAsyncWithHttpInfo($cartId)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation quoteGuestCartRepositoryV1GetGetAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $cartId (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quoteGuestCartRepositoryV1GetGetAsyncWithHttpInfo($cartId)
    {
        $returnType = '\Krak\MagentoApiClient\Model\QuoteDataCartInterface';
        $request = $this->quoteGuestCartRepositoryV1GetGetRequest($cartId);
    ...
    /**
     * Create request for operation 'quoteGuestCartRepositoryV1GetGet'
     *
     * @param  string $cartId (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function quoteGuestCartRepositoryV1GetGetRequest($cartId)
    {
        // verify the required parameter 'cartId' is set
        if ($cartId === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cartId when calling quoteGuestCartRepositoryV1GetGet'
            );
        }
