...
class NegotiableQuoteAttachmentContentManagementV1Api
{
     ...
     * @throws \Krak\MagentoApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Krak\MagentoApiClient\Model\NegotiableQuoteDataAttachmentContentInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function negotiableQuoteAttachmentContentManagementV1GetGetWithHttpInfo($attachmentIds)
    {
        $returnType = '\Krak\MagentoApiClient\Model\NegotiableQuoteDataAttachmentContentInterface[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Krak\MagentoApiClient\Model\NegotiableQuoteDataAttachmentContentInterface[]',
