...
class CatalogProductTierPriceManagementV1Api
{
     ...
     * @throws \Krak\MagentoApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Krak\MagentoApiClient\Model\CatalogDataProductTierPriceInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function catalogProductTierPriceManagementV1GetListGetWithHttpInfo($sku, $customerGroupId)
    {
        $returnType = '\Krak\MagentoApiClient\Model\CatalogDataProductTierPriceInterface[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Krak\MagentoApiClient\Model\CatalogDataProductTierPriceInterface[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
